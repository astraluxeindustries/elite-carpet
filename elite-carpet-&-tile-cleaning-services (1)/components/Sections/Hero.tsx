  ...
  return (
    <section id="hero" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1527513913502-33fa3f5451aa?auto=format&fit=crop&q=80&w=2000"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-20">
        <div className="max-w-3xl">
          ...
          >
            ...
            <a href="#services">
              <Button variant="white" className="backdrop-blur-sm bg-white/10 text-white border-white/20 hover:bg-white/20">
                Explore Services
              </Button>
            </a>
          </motion.div>
